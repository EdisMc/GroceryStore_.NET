"Grocery Store Management System" is a desktop application developed with C# (.NET Framework), WinForms and SQL. The information system provides the following capabilities:
